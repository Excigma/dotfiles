...
active_text_color="#3498db"
active_bg="#272b33"
active_underline="#315396"

inactive_text_color="#b8b8b8"
inactive_bg=
inactive_underline=
...
generate_window_list() {
	not_monocle=$(bspc query -D -d focused.monocle | grep -E "0x")
